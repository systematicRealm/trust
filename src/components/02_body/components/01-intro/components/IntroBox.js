...
export default function IntroBox() {
  return (
    <div className="relative flex flex-col w-1/2 gap-3 px-10 py-8 bg-transparent shadow-md text-neutral-200 backdrop-blur-xl before:bg-transparent-black before:w-full before:h-full before:absolute before:top-0 before:left-0 rounded-3xl before:rounded-3xl">
      <div className="z-10 flex leading-6 he">
      ...
      <div className="z-10 flex leading-6">
